...
extern be_node *be_alloc(be_type type);
...
extern be_node *_be_decode(const char **bencode, long long *bencode_len);
extern void be_free(be_node *node);
extern void be_dump(be_node *node);
extern void dump_string(const char *str, long long len);
